...
class Music_Download:
    ...
    def download_song(self):
        ...
        self.ui.label_state.setText(
            '正在下载' + self.song_name + '-' + self.song_artist + '.mp3')
        ...
        self.pause_state = 1
        self.ui.label_state.setText(
            '正在播放： ' + self.song_name + '-' + self.song_artist + '.mp3')
    ...
    def pause_song(self):
        if self.pause_state == 1:
            ...
            self.ui.label_state.setText(
                '已暂停： ' + self.song_name + '-' + self.song_artist + '.mp3')
            self.pause_state = 0
        else:
